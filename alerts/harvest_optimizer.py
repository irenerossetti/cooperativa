...
class HarvestOptimizer:
    ...
    def get_planting_date(self, parcel):
        """Obtiene la fecha de siembra de la parcela"""
        # Intentar obtener de actividades agrícolas
        try:
        ...
        # Si no hay actividad, usar fecha de creación de la parcela (aproximación)
    ...
    def calculate_maturation_score(self, parcel):
        ...
        if not planting_date:
            return 50  # Score neutral si no hay fecha
